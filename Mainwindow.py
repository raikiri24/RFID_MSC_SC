...
class MainWindow:
    ...
    def __init__(self, root, *args, **kwargs):
        ...
        def clicked_emp():
            ...
            self.name_label = Label(self.frame_emp, text="First Name", font=("Andalus", 12, 'bold'), 
            fg="black")
            ...
            self.gender_label = Label(self.frame_emp, text="Sex", font=("Andalus", 12, 'bold'),
            fg="black")
            self.gender_label.place(x=20, y=350)

            self.bdate_label = Label(self.frame_emp, text="Birth Date", font=("Andalus", 12, 'bold'),
            fg="black")     
            ...
            self.Salary_label = Label(self.frame_emp, text="Salary Grade", font=("Andalus", 12, 'bold'),
            fg="black")
            ...
            self.contact_label = Label(self.frame_emp, text="Contact Details", font=("Andalus", 12, 'bold'),
            fg="black")
